...
public class TestHelpers {
  ...
  public static Company company1 = new Company(1L, "Pampers", "11", "Koncertowa 6/8, 80-301 Warszawa", BigDecimal.ZERO, BigDecimal.ZERO);
  public static Company company2 = new Company(2L, "Mars", "22", "Slowackiego 6/8, 80-302 Katowice", BigDecimal.ZERO, BigDecimal.ZERO);
  public static Company company3 = new Company(3L, "Apple", "33", "Czarnogorska 6/8, 80-303 Gdansk", BigDecimal.ZERO, BigDecimal.ZERO);
  public static Company company4 = new Company(4L, "NewCompany1", "44", "Nowa 6/8, 80-303 Gdansk", BigDecimal.valueOf(13000), BigDecimal.ZERO);
  public static Company company5 = new Company(5L, "NewCompany2", "55", "Stara 6/8, 80-303 Gdansk", BigDecimal.valueOf(30000), BigDecimal.ZERO);

  public static Car car1 = new Car(1L, "DW123CT", true);
  public static Car car2 = new Car(2L, "DW122FC", true);
  public static Car car3 = new Car(3L, "DW345JK", true);

  public static InvoiceEntry invoiceEntry1 =
      new InvoiceEntry(1L, "Baton", BigDecimal.valueOf(1), BigDecimal.valueOf(100), BigDecimal.valueOf(100 * 0.08), Vat.VAT_8, null);
  public static InvoiceEntry invoiceEntry2 =
      new InvoiceEntry(2L, "Chleb", BigDecimal.valueOf(1), BigDecimal.valueOf(200), BigDecimal.valueOf(200 * 0.05), Vat.VAT_5, null);
  public static InvoiceEntry invoiceEntry3 =
      new InvoiceEntry(3L, "Kakao", BigDecimal.valueOf(1), BigDecimal.valueOf(300), BigDecimal.valueOf(300 * 0.23), Vat.VAT_23, null);
  public static InvoiceEntry invoiceEntry4 =
      new InvoiceEntry(4L, "fuel", BigDecimal.valueOf(1), BigDecimal.valueOf(123), BigDecimal.valueOf(123 * 0.08), Vat.VAT_8, car1);
  public static InvoiceEntry invoiceEntry5 =
      new InvoiceEntry(5L, "fuel", BigDecimal.valueOf(1), BigDecimal.valueOf(4000), BigDecimal.valueOf(4000 * 0.05), Vat.VAT_5, car2);
  public static InvoiceEntry invoiceEntry6 =
      new InvoiceEntry(6L, "fuel", BigDecimal.valueOf(1), BigDecimal.valueOf(5500), BigDecimal.valueOf(5500 * 0.23), Vat.VAT_23, car3);
