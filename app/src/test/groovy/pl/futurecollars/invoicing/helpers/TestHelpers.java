...
public class TestHelpers {
  ...
  public static Company company4 = new Company("NewTestCompany1", "44", "Czarnogorska 6/8, 80-303 Gdansk", BigDecimal.valueOf(13000), BigDecimal.ZERO);
  public static Company company5 = new Company("NewTestCompany2", "55", "Czarnogorska 6/8, 80-303 Gdansk", BigDecimal.valueOf(30000), BigDecimal.ZERO);

  public static Car companyCar1 = new Car("DW123CT",true);
  public static Car companyCar2 = new Car("DW122FC",true);
  public static Car companyCar3 = new Car("DW345JK", true);
  ...
  public static InvoiceEntry invoiceEntry4 = new InvoiceEntry("Paliwo", 1, BigDecimal.valueOf(123), BigDecimal.valueOf(123 * 0.08), Vat.VAT_8, companyCar1);
  public static InvoiceEntry invoiceEntry5 = new InvoiceEntry("Paliwo", 1, BigDecimal.valueOf(4000), BigDecimal.valueOf(4000 * 0.05), Vat.VAT_5, companyCar2);
  public static InvoiceEntry invoiceEntry6 = new InvoiceEntry("Paliwo", 1, BigDecimal.valueOf(5500), BigDecimal.valueOf(5500 * 0.23), Vat.VAT_23,companyCar3);
